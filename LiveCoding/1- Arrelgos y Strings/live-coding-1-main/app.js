...
2.- Construye una función que reciba por parámetros un array de strings y lo imprima dentro de la lista () en el index.html. 
La función debe mostrar la lista en el HTML manipulando el DOM, cada string del arreglo debe imprimirse en un elemento
...
1.- Crea un input en el HTML donde el usuario pueda escribir la palabra que se mandará por parámetros a la primera función. 2.- Crea un botón en el HTML. 
Cuando el usuario de click al botón debe dispararse un evento en el cual se invocará la primera función y recibirá lo que el usuario escriba en el input como el string. 
Después el array resultante será pasado a la segunda función para mostrarlo en el HTML.
...
const arr = ['Gusano', 'Oso', 'Dragon', 'Dromedario', 'Escarabajo', 'Ballena', 'Leon', 'Cocodrilo', 'Serpiente', 'Canguro', 'Albatroz']
const arrN = []

let word = 'Camello'
        
function arrStr(word, arr){
...
btn.addEventListener('click', () => {
    ...
    const arr = ['Gusano', 'Oso', 'Dragon', 'Dromedario', 'Escarabajo', 'Ballena', 'Leon', 'Cocodrilo', 'Serpiente', 'Canguro']
    const arrN = []
